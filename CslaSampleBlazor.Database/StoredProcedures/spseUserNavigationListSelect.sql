--region [dbo].[spseUserNavigationListSelect]

------------------------------------------------------------------------------------------------------------------------
-- Generated By:   Text Templates
-- Template:       CRUDTenantStoredProcedures.tt
-- Procedure Name: [dbo].[spseUserNavigationListSelect]
-- Date Generated: Wednesday, June 27, 2018
------------------------------------------------------------------------------------------------------------------------

CREATE PROCEDURE [dbo].[spseUserNavigationListSelect]
	@NavigationType INT,
	@UserKey INT
AS
...
WHERE
	(@NavigationType IS NULL OR [tseNavigation].[NavigationType] = @NavigationType)
--endregion
